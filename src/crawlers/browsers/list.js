...
const list = [
    ...
    {id: "googleWebUpdates", link: 'https://developers.google.com/web/updates/', parser: googleWebUpdates, prettyName: "Google Web Updates"},
    {id: "edgeBlog", link: 'https://blogs.windows.com/msedgedev/feed/', parser: MicrosoftXMLPage, prettyName: "Edge"},
    // {id: "safariReleaseNotes", link: 'https://developer.apple.com/documentation/safari_release_notes', parser: safariReleaseNotes, prettyName: "Safari"},
