...
const list = [
    ...
    {id: "xboxOne", link: 'https://beta.support.xbox.com/help/hardware-network/settings-updates/whats-new-xbox-one-system-updates', parser: xboxOne, querySelectorParam: '.ms-GroupedList', prettyName: "Xbox One"},
];
